...
<?php
 $dir = new DirectoryIterator(dirname(__FILE__).'//..//save-uploads//');
foreach ($dir as $fileinfo) {
    if (!$fileinfo->isDot()) {
        if (stristr($fileinfo->getFilename(), "VMI")) {
            print('<tr><td colspan="2" align="center"><a href="../save-uploads/'.$fileinfo->getFilename().'">'.$fileinfo->getFilename().'</a><br></td></tr>');
        }
    }
}
?>
